...
// CreateJobListingInput is the resolver for the createJobListingInput field.
func (r *mutationResolver) CreateJobListingInput(ctx context.Context, input model.CreateJobListingInput) (*model.JobListing, error) {
